...
void updateValdiation(){
    ...
    DbValidator::allDb.push_back(LocalParameters::DBTYPE_CA_ALPHA_DIFF);
    ...
    DbValidator::allDbAndFlat.push_back(LocalParameters::DBTYPE_CA_ALPHA_DIFF);
...
std::vector<struct Command> commands = {
        ...
        {"convert2pdb",          convert2pdb,             &localPar.onlyverbosity,        COMMAND_FORMAT_CONVERSION,
                ...
                "Milot Mirdita <milot@mirdita.de>",
                "<i:Db> <o:pdbFile>",
                CITATION_MMSEQS2, {{"Db", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA|DbType::NEED_HEADER, &DbValidator::sequenceDb },
