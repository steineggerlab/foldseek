...
LocalParameters::LocalParameters() :
        ...
        PARAM_DB_EXTRACTION_MODE(PARAM_DB_EXTRACTION_MODE_ID, "--db-extraction-mode", "Createdb extraction mode", "createdb extraction mode: 0: chain 1: interface 2: dimer", typeid(int), (void *) &dbExtractionMode, "^[0-2]{1}$"),
