...
LocalParameters::LocalParameters() :
        ...
        PARAM_COMPLEX_TM_THRESHOLD(PARAM_COMPLEX_TM_THRESHOLD_ID, "--complex-tmscore-threshold", "Complex TMscore threshold", "accept alignments with a q complex tmsore > thr [0.0,1.0]",typeid(float), (void *) &complexTMScoreThreshold, "^0(\\.[0-9]+)?|1(\\.0+)?$"),
