...
//    tmalign.push_back(&PARAM_GAP_EXTEND);
    ...
    citations.emplace(CITATION_FOLDSEEK_MULTIMER, "Kim, W., Mirdita, M., Levy Karin, E., Gilchrist, C.L.M., Schweke, H., Söding, J., Levy, E., and Steinegger, M. Rapid and sensitive protein complex alignment with Foldseek-Multimer. Nat Methods, doi:org/10.1038/s41592-025-02593-7 (2025)");                                
