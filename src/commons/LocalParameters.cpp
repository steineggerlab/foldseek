...
const int LocalParameters::DBTYPE_CA_ALPHA_DIFF = 104;
...
std::vector<int> FoldSeekDbValidator::cadb = {LocalParameters::DBTYPE_CA_ALPHA, LocalParameters::DBTYPE_CA_ALPHA_F16, LocalParameters::DBTYPE_CA_ALPHA_DIFF};
