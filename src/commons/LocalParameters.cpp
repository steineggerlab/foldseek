...
LocalParameters::LocalParameters() :
        ...
        PARAM_PROSTT5_SPLIT_LENGTH(PARAM_PROSTT5_SPLIT_LENGTH_ID, "--prostt5-split-length", "ProstT5 split length", "Maximum split length for split-wise prediction of sequences longer than ProstT5 attention", typeid(int), (void *) &prostt5SplitLength, "^[0-9]+$", MMseqsParameter::COMMAND_COMMON),
...
//    tmalign.push_back(&PARAM_GAP_EXTEND);
    ...
    citations.emplace(CITATION_PROSTT5, "Heinzinger, M., Weissenow, K., Gomez Sanchez, J., Henkel, A., Mirdita, M., Steinegger, M., and Burkhard, R. Bilingual Language Model for Protein Sequence and Structure. bioRxiv, doi:10.1101/2023.07.23.550085 (2024)");
