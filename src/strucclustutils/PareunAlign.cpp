...
vector<int> PareunAlign::AlignedResidueIndex(struct Matcher::result_t optAlnResult) {
...
Matcher::result_t PareunAlign::align(Sequence &qSeq, Sequence &tSeq, SubstitutionMatrix *subMat, Coordinates *queryCaCords, Coordinates *targetCaCords, EvalueComputation evaluer) {
