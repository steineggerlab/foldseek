...
public:
    ...
    static int get_PDB_lines(std::istream& fin, vector<vector<string> >&PDB_lines,
 ...
 * return length of alignment, including gap. */
    static int extract_aln_from_resi(vector<string> &sequence, char *seqx, char *seqy,
